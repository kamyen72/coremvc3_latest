namespace CoreMVC3.Classes
{
    ...
    public static class db_local_master
    {
        public static string connStr = "Server=localhost;Database=MasterGHL;User Id=sa;Password=p@ssw0rd;TrustServerCertificate=true;";
        public static string dbfullname = "MasterGHL";
        public static string ip = "localhost";
        public static string userId = "sa";
        public static string password = "p@ssw0rd";
        public static string MyID = "db_local_master";
    }
